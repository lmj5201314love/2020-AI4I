...
SELECT CASE
        ...
        WHEN Torque >= 30
        AND Torque < 40 THEN '30-40'
        WHEN Torque >= 40
        AND Torque < 50 THEN '40-50'
        WHEN Torque >= 50
        AND Torque < 60 THEN '50-60'
...
SELECT CASE
        ...
        WHEN Rotational_speed >= 1300
        AND Rotational_speed < 1500 THEN '1300-1500'
        WHEN Rotational_speed >= 1500
        AND Rotational_speed < 1700 THEN '1500-1700'
        WHEN Rotational_speed >= 1700
        AND Rotational_speed < 1900 THEN '1700-1900'

/*
Day 4 - Reusable SQL views
Project: AI4I 2020 Predictive Maintenance

Purpose:
Create reusable views for repeated analysis.
Run this after sql/02_check_import.sql has confirmed that the imported table is correct.
*/
